...
export default function AuthLogin() {
  ...
  const handleProviderLogin = async (providerId: "google" | "github" | "microsoft") => {
    try {
      await authClient.signIn.social({
        ...
        onError: (ctx) => {
          setError(ctx.error.message || `An error occurred during social sign in. Please try again.`); 
          setIsLoading(false);
        },
      }
    );
    ...
    <form className="p-6 md:p-8" onSubmit={handleSubmit}>
      <FieldGroup>
        ...
        <Field className="grid grid-cols-3 gap-4">
          ...
          <Button variant="outline" type="button" onClick={() => handleProviderLogin("microsoft")} disabled={isLoading}>
